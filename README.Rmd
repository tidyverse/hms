...
```{r, echo = FALSE}
# Keep the render reproducible: this README prints the current
# time, which would otherwise make every render a diff.
Sys.time <- function() as.POSIXct("2026-09-13 09:30:00", tz = "UTC")
