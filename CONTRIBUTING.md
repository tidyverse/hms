...
This outlines how to propose a change to hms. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("batpigandme/hms", fork = TRUE)`.
...
Please note that the hms project is released with a [Contributor Code of
Conduct](https://hms.tidyverse.org/CODE_OF_CONDUCT.md). By contributing
