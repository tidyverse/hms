...
- [`is.hms()`](https://hms.tidyverse.org/reference/Deprecated.md) and
  [`as.hms()`](https://hms.tidyverse.org/reference/Deprecated.md) now
  warn even when called indirectly
...
- Implement
  [`ceiling_hms()`](https://hms.tidyverse.org/reference/round_hms.md)
  and [`floor_hms()`](https://hms.tidyverse.org/reference/round_hms.md)
  ([@moodymudskipper](https://github.com/moodymudskipper),
...
- `vec_cast()` and
  [`as_hms()`](https://hms.tidyverse.org/reference/hms.md) throw error
  instead of a warning if input can’t be parsed
...
- [`as_hms()`](https://hms.tidyverse.org/reference/hms.md) is a generic
  again ([\#81](https://github.com/tidyverse/hms/issues/81)).
...
- `"hms"` objects no longer have a common type with `character` and
  ...
  throws an error ([\#94](https://github.com/tidyverse/hms/issues/94)).
- `vec_cast()` and
  [`as_hms()`](https://hms.tidyverse.org/reference/hms.md) now throw
...
- [`as_hms()`](https://hms.tidyverse.org/reference/hms.md) is a generic
  again ([\#81](https://github.com/tidyverse/hms/issues/81)).
- [`round_hms()`](https://hms.tidyverse.org/reference/round_hms.md) and
  [`trunc_hms()`](https://hms.tidyverse.org/reference/round_hms.md) gain
  `digits` argument ([\#78](https://github.com/tidyverse/hms/issues/78),
  [@hglanz](https://github.com/hglanz)).

### Bug fixes

- [`as_hms()`](https://hms.tidyverse.org/reference/hms.md) and
...
- Now based on vctrs \>= 0.2.0
  ...
  [`new_hms()`](https://hms.tidyverse.org/reference/hms.md) constructor
  permits safe construction of `hms` objects from a numeric vector.

- The new [`is_hms()`](https://hms.tidyverse.org/reference/hms.md)
  deprecates the existing
  [`is.hms()`](https://hms.tidyverse.org/reference/Deprecated.md).
  [`as.hms()`](https://hms.tidyverse.org/reference/Deprecated.md) is
  deprecated in favor of `vec_cast()` or the new
  [`as_hms()`](https://hms.tidyverse.org/reference/hms.md) (which is
...
- [`as.hms.POSIXt()`](https://hms.tidyverse.org/reference/Deprecated.md)
...
- New [`round_hms()`](https://hms.tidyverse.org/reference/round_hms.md)
  and [`trunc_hms()`](https://hms.tidyverse.org/reference/round_hms.md)
  for rounding or truncating to a given multiple of seconds
  ([\#31](https://github.com/tidyverse/hms/issues/31)).
- New [`parse_hms()`](https://hms.tidyverse.org/reference/parse_hms.md)
  and [`parse_hm()`](https://hms.tidyverse.org/reference/parse_hms.md)
...
- Fix and enhance examples in
  [`?hms`](https://hms.tidyverse.org/reference/hms.md).
- Documentation is in Markdown format now.
- Improved error message if calling
  [`hms()`](https://hms.tidyverse.org/reference/hms.md) with a character
  argument ([\#29](https://github.com/tidyverse/hms/issues/29)).
...
- [`format.hms()`](https://hms.tidyverse.org/reference/hms.md)
  right-justifies the output by padding with spaces from the left,
  [`as.character.hms()`](https://hms.tidyverse.org/reference/hms.md)
  remains unchanged.
...
- Interface:
  - [`hms()`](https://hms.tidyverse.org/reference/hms.md) (with rigorous
    argument checks)
  - [`as.hms()`](https://hms.tidyverse.org/reference/Deprecated.md) for
    `character`, `numeric`, `POSIXct` and `POSIXlt`
  ...
  - [`format.hms()`](https://hms.tidyverse.org/reference/hms.md)
  - [`print.hms()`](https://hms.tidyverse.org/reference/hms.md) (returns
    unchanged input invisibly)
