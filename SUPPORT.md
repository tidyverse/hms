...
Thanks for using hms! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/batpigandme/hms/issues/new).
...
requests](https://github.com/batpigandme/hms/issues) to make sure the
